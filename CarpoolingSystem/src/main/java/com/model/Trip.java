...
public class Trip implements Serializable {
	...
	public String toString() {
		return "Trip [tripID=" + tripID + ", carID=" + carID + ", dateTime=" + dateTime + ", destPoint=" + destPoint
				+ ", endDate=" + endDate + ", frequency=" + frequency + ", meetingPoints=" + meetingPoints
				+ ", preferences=" + preferences + ", spotsAvailable=" + spotsAvailable + ", startPoint=" + startPoint
				+ ", bookings=" + bookings + ", driverdetail=" + driverdetail + "]";
	}
