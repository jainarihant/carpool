...
public class Booking implements Serializable {
	...
	public String toString() {
		return "Booking [bookingID=" + bookingID + ", bookingStatus=" + bookingStatus + ", departDateTime="
				+ departDateTime + ", ratingForDriver=" + ratingForDriver + ", ratingForPassenger=" + ratingForPassenger
				+ ", spotsReserved=" + spotsReserved + ", passengerdetail=" + passengerdetail + ", trip=" + trip
